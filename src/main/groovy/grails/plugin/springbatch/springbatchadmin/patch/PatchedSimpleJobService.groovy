package grails.plugin.springbatch.springbatchadmin.patch
...
class PatchedSimpleJobService extends SimpleJobService {
    ...
    Collection<StepExecution> getStepExecutions(Long jobExecutionId) throws NoSuchJobExecutionException {
        ...
        if (jobName != null) {
            ...
            log.debug("Found step executions in repository: " + missingStepNames)
        }
        ...
        if (job instanceof StepLocator) {
            ...
            log.debug("Added step executions from job: " + missingStepNames)
        }
        ...
        for (StepExecution stepExecution : jobExecution.stepExecutions) {
            ...
            log.debug("Removed step executions from job execution: " + missingStepNames)
        }
